...
insert into m_dimensions values (2, 1003, 'age', '年龄', '', 0, 'number', 1, now(), 0);
insert into m_dimensions values (3, 1003, 'order_no', '订单号', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (4, 1003, 'pay_time', '购买时间', '', 0, 'time', 1, now(), 0);
insert into m_dimensions values (5, 1003, 'buy_channel', '购买渠道', '', 0, 'enum', 1, now(), 0);
insert into m_dimensions values (6, 1003, 'pay_date', '购买日期', '', 0, 'time', 1, now(), 0);
insert into m_dimensions values (7, 1003, 'store_type', '业态', '', 0, 'enum', 1, now(), 0);
insert into m_dimensions values (8, 1003, 'tag_category', '标签字段归类', '', 0, 'enum', 1, now(), 0);
insert into m_dimensions values (9, 1003, 'physical_table_id', '物理表ID', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (10, 1003, 'logical_table_column_id', '逻辑表列ID', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (13, 1003, 'app_action_type', 'APP行为类型', '', 0, 'enum', 1, now(), 0);
insert into m_dimensions values (14, 1003, 'action_time', '行为时间', '', 0, 'time', 1, now(), 0);
insert into m_dimensions values (15, 1003, 'order_action_type', '订单行为类型', '', 0, 'enum', 1, now(), 0);
insert into m_dimensions values (16, 1003, 'membership_level1', '会员等级', '', 0, 'enum', 1, now(), 0);
insert into m_dimensions values (17, 1003, 'crowd_id', '人群ID', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (18, 1003, 'crowd_name', '人群名称', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (19, 1003, 'instance_id', '人群实例ID', '', 0, 'string', 1, now(), 0);

insert into m_dimensions values (9001, 1003, 'a', '事件名称', '', 0, 'enum', 1, now(), 0);
insert into m_dimensions values (9002, 1003, 'id_m', '用户id', '', 1, 'string', 1, now(), 0);
insert into m_dimensions values (9003, 1003, 'member_name', '会员姓名', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9004, 1003, 'gender', '性别', '', 0, 'enum', 1, now(), 0);
insert into m_dimensions values (9005, 1003, 'birthday', '生日', '', 0, 'time', 1, now(), 0);
insert into m_dimensions values (9006, 1003, 'id_p', '手机号', '', 2, 'string', 1, now(), 0);
insert into m_dimensions values (9007, 1003, 'time', '用户访问数据的时间', '', 0, 'time', 1, now(), 0);
insert into m_dimensions values (9008, 1003, 'email', '邮箱', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9009, 1003, 'reg_date', '注册时间', '', 0, 'time', 1, now(), 0);
insert into m_dimensions values (90010, 1003, 'reg_store', '注册门店', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90011, 1003, 'membership_level', '会员等级', '', 0, 'enum', 1, now(), 0);
insert into m_dimensions values (90012, 1003, 'id_wx', '微信openid', '', 3, 'string', 1, now(), 0);
insert into m_dimensions values (90013, 1003, 'official_account', '关注公众号', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90014, 1003, 'app_id', '应用id', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90015, 1003, 'app_name', '应用名称', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90016, 1003, 'province', '省', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90017, 1003, 'city', '市', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90018, 1003, 'area', '区', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90019, 1003, 'ip', '用户访问时的ip', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90020, 1003, 'timezone', '客户端本地时区', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90021, 1003, 'mac', 'MAC地址', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90022, 1003, 'browser', '浏览器名称', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90023, 1003, 'os', '操作系统名称', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90024, 1003, 'net', '网络类型', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90025, 1003, 'carrier', '运营商', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90026, 1003, 'model', '设备型号', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90027, 1003, 'sid', '会话id', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90028, 1003, 'cookie', '客户端cookie唯一标识', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90029, 1003, 'agent', '客户端信息', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90030, 1003, 'ute', '客户系统用户类型', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90032, 1003, 'channel_id', '渠道id', '', 0, 'enum', 1, now(), 0);
insert into m_dimensions values (90033, 1003, 'channel_name', '渠道名称', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90034, 1003, 'current_url', '当前页面地址', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90035, 1003, 'guest_url', '访问的页面地址', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90036, 1003, 'source_url', '跳转来源地址', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90037, 1003, 'source_id', '页面来源id', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90038, 1003, 'source_name', '页面来源名称', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90039, 1003, 'page_id', '页面id', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90040, 1003, 'page_name', '页面名称', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90041, 1003, 'assembly_id', '组件id', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90042, 1003, 'assembly_name', '组件名称', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90043, 1003, 'jump_page_id', '要跳转的页面id', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90044, 1003, 'jump_page_name', '要跳转的页面名称', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90045, 1003, 'a_type', '事件类型', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90046, 1003, 'p_type', '组件化：1', '', 0, 'number', 1, now(), 0);
insert into m_dimensions values (90047, 1003, 'a_source', '事件来源', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90048, 1003, 'version', '埋点方案版本', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90101, 1003, 'shop_id', '关联门店', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90102, 1003, 'receiver_address', '收货地址', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9022, 1003, 'coupon_id', '优惠券id', '', 0, 'enum', 1, now(), 0);
insert into m_dimensions values (9023, 1003, 'discount', '折扣金额', '', 0, 'number', 1, now(), 0);
insert into m_dimensions values (9024, 1003, 'is_buy_again', '是否再次购买', '', 0, 'boolean', 1, now(), 0);
insert into m_dimensions values (9025, 1003, 'is_coupon_used', '是否使用优惠券', '', 0, 'boolean', 1, now(), 0);
insert into m_dimensions values (9026, 1003, 'is_point_used', '是否使用积分', '', 0, 'boolean', 1, now(), 0);
insert into m_dimensions values (9027, 1003, 'is_refund', '是否退款', '', 0, 'boolean', 1, now(), 0);
insert into m_dimensions values (9028, 1003, 'is_return', '是否退货', '', 0, 'boolean', 1, now(), 0);
insert into m_dimensions values (9029, 1003, 'order_id', '订单号', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90210, 1003, 'order_status', '订单状态', '', 0, 'number', 1, now(), 0);
insert into m_dimensions values (90212, 1003, 'payment_method', '支付方式', '', 0, 'number', 1, now(), 0);
insert into m_dimensions values (90213, 1003, 'payment_time', '支付时间', '', 0, '时间戳', 1, now(), 0);
insert into m_dimensions values (90216, 1003, 'product_id', '商品id', '', 0, 'enum', 1, now(), 0);
insert into m_dimensions values (90220, 1003, 'return_order_id', '退单号', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90221, 1003, 'return_product_id', '退单商品id', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (90222, 1003, 'to_shop_or_home_delivery', '到店/到家', '', 0, 'boolean', 1, now(), 0);
insert into m_dimensions values (9031, 1003, 'is_add_to_shoppingcart', '是否加入购物车', '', 0, 'boolean', 1, now(), 0);
insert into m_dimensions values (9032, 1003, 'is_flash_sale', '是否秒杀', '', 0, 'boolean', 1, now(), 0);
insert into m_dimensions values (9033, 1003, 'is_in_stock', '商品是否上架', '', 0, 'boolean', 1, now(), 0);
insert into m_dimensions values (9034, 1003, 'is_modify_good_num_in_shoppingcart', '是否购物车商品增加减少数量', '', 0, 'boolean', 1, now(), 0);
insert into m_dimensions values (9044, 1003, 'share_channel', '分享方式', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9061, 1003, 'activity_id', '活动id', '', 0, 'enum', 1, now(), 0);
insert into m_dimensions values (9062, 1003, 'activity_name', '活动名称', '', 0, 'string', 1, now(), 0);

insert into m_dimensions values (9100, 1003, 'current_points', '当前积分', '', 0, 'number', 1, now(), 0);
insert into m_dimensions values (9101, 1003, 'used_points', '已使用积分', '', 0, 'number', 1, now(), 0);
insert into m_dimensions values (9102, 1003, 'available_coupon_num', '未使用优惠券数量', '', 0, 'number', 1, now(), 0);
insert into m_dimensions values (9103, 1003, 'used_coupon_num', '已使用优惠券数量', '', 0, 'number', 1, now(), 0);
insert into m_dimensions values (9104, 1003, 'agebracket', '年龄阶段', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9105, 1003, 'constellation', '星座', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9106, 1003, 'customerlifecyclestage', '生命周期', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9107, 1003, 'memberbuyinfo', '会员价值', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9108, 1003, 'memberloyalty', '会员忠诚度', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9109, 1003, 'preferredbrand', '商品偏好', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9110, 1003, 'preferredcategory', '品类偏好', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9111, 1003, 'pricesensitivity', '价格敏感度', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9112, 1003, 'discountsensitivity', '优惠敏感度', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9113, 1003, 'preferredconsumptionchannel', '消费渠道偏好', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9114, 1003, 'preferredinteractchannel', '互动渠道偏好', '', 0, 'string', 1, now(), 0);
insert into m_dimensions values (9115, 1003, 'preferredactiontype', '活动类型偏好', '', 0, 'string', 1, now(), 0);
