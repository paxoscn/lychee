...
insert into m_logical_table_columns values (911721, 18, 'agebracket', '年龄阶段', '', 9103, 0, 0);
insert into m_logical_table_columns values (911722, 18, 'constellation', '星座', '', 9103, 0, 0);
